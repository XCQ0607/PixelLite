...
import { ArrowLeft, Trash2, Download, CheckSquare, Square, AlertTriangle, Archive, FileImage, Loader2, Wand2, Minimize2, ArrowUpRight, ArrowDownRight, Minus } from 'lucide-react';
                   ...
                   <div className="flex gap-4 flex-1 min-w-0">
                      ...
                      <div className="flex flex-col justify-center min-w-0">
                        <h4 className="font-bold text-gray-800 dark:text-gray-200 flex items-center gap-2" title={item.originalFile.name}>
                          ...
                          <span className={`shrink-0 px-1.5 py-0.5 rounded text-[10px] font-bold uppercase flex items-center gap-1 ${
                              isEnhance ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300' : 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300'
                          }`}>
                        ...
                        <div className="flex items-center gap-3 text-xs text-gray-500 dark:text-gray-400 mt-1">
                          ...
                          <span className={`px-1.5 py-0.5 rounded font-bold ${
                              isEnhance ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600' : 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400'
