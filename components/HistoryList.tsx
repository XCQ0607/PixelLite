...
import { Download, MoreHorizontal, Loader2, Sparkles, Minimize2, Wand2, ArrowUpRight, ArrowDownRight, Minus } from 'lucide-react';
          ...
          return (
            ...
            >
              ...
              <div className="absolute top-3 left-3 z-20">
                  <div className={`px-2 py-1 rounded-md shadow-sm text-xs font-bold flex items-center gap-1.5 ${
                      isEnhance 
